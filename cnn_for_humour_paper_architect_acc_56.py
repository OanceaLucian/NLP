...
if train == 1:
    ...
    model.summary()
    filepath = "ted_real_weights-improvement_50_-{epoch:02d}-{val_acc:.2f}.hdf5"
...
predict = 1
if predict:
    model.load_weights("ted_real_weights-improvement_50_-08-0.59.hdf5")
    model.compile(loss='categorical_crossentropy',
                  optimizer='adam',
                  metrics=['acc'])
